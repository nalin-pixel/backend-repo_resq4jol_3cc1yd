...
app = FastAPI(title="Sparkle & Shine Cleaning API")
...
@app.get("/")
def read_root():
    return {"message": "Sparkle & Shine Cleaning API is running"}
...
# Lead submission model for request validation
class LeadRequest(Lead):
    pass

@app.post("/api/leads")
def submit_lead(lead: LeadRequest):
    """Store a new lead/quote request in the database"""
    try:
